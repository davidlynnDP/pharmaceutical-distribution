...
export const initialInformation: SeedData = {
    ...
    products: [
        ...
        {
            name: 'Ibuprofen',
            description: 'Medicamento antiinflamatorio no esteroideo (AINE)',
            stocks: 80,
            price: 7000,
        },
        {
            name: 'Omeprazole',
            description: 'Medicamento inhibidor de la bomba de protones',
            stocks: 60,
            price: 10000,
        },
        {
            name: 'Loratadine',
            description: 'Medicamento antihistamínico',
            stocks: 50,
            price: 6000,
        },
        {
        ...
        {
            name: 'Aspirin',
            description: 'Medicamento analgésico y antiinflamatorio',
            stocks: 90,
            price: 4000,
        },
        {
            name: 'Simvastatin',
            description: 'Medicamento estatina para reducir el colesterol',
            stocks: 40,
            price: 15000,
        },
        {
        ...
        {
            name: 'Warfarin',
            description: 'Medicamento anticoagulante',
            stocks: 30,
            price: 13000,
        }
    ],
